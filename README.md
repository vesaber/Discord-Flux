...
- bot
  - View Channel
  - Attach Files (this is not being used for now, but probably is good to have on for later features)
  - Use External Emojis
  - Send Messages
...
The bot currently only has one command and it's to bridge a channel manually from discord
